                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(admTxt)
                            .addComponent(admPass, javax.swing.GroupLayout.DEFAULT_SIZE, 187, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(154, 154, 154)
...
this.hide();        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         try {
        if(admTxt.getText().length()==0){
    JOptionPane.showMessageDialog(this,"All fields required!");
        }
else if(admPass.getText().length()==0){
JOptionPane.showMessageDialog(this, "All fields required");
}
else{
    
    String username=admTxt.getText();
     String passwd=admPass.getText();//Connection con = (Connection) java.sql.DriverManager.getConnection("jdbc:mysql://localhost/studentmanagement","root","");

           
    Class.forName("com.mysql.cj.jdbc.Driver");
      con= DriverManager.getConnection("jdbc:mysql://localhost/studentmanagement","root","");
      pst=(PreparedStatement) con.prepareStatement("select * from lectures where lecture_id= ?");
      pst.setString(1,username);
      rs=(ResultSet) pst.executeQuery();
      if(rs.next()){
          if(rs.getString("password").equals(passwd) ){
               AddMarks mk = new AddMarks();
               this.hide();
                mk.setVisible(true);
          }else{
        ...
        JOptionPane.showMessageDialog(this, "User unknown or incorrect!");
    }
}}
